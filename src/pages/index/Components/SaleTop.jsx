    ...
    return (
      <View className='sale-top-wrap'>
        {/* <View className='title-list-top'>
          ...
          <View className='icon'>
            <Image src='http://qiniu.fmg.net.cn/picture-1598882342000' style='width:140rpx;height:70rpx' />
          </View>
          <View className='more'>
        ...
        <View className='goodsList'>
          <View className='left-item'>
            ...
            <Image src='http://qiniu.fmg.net.cn/picture-1606024868000' className='range-1' />
            <Image
          ...
          <View className='mid-right-icon-wrap'>
            <View className='icon-info-wrap'>
              <Image src='http://qiniu.fmg.net.cn/picture-1598882342000' />
              <View className='info'>凤鸣谷好物畅销排行榜</View>
            </View>
            <View className='mid-right-wrap'>
              <View className='mid-item'>
                {/* <View className='number'>2</View> */}
                <Image src='http://qiniu.fmg.net.cn/picture-1606024893000' className='range-2' />
                <Image
              ...
              <View className='right-item'>
                ...
                <Image src='http://qiniu.fmg.net.cn/picture-1606024903000' className='range-3' />
                <Image
